...
Revision ID: 9de84701e74f
Revises: 22d8f6114904
Create Date: 2023-06-03 14:05:52.255272
...
revision = '9de84701e74f'
down_revision = '22d8f6114904'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('purchase_order_id', 'product_id', name='product_purchase_order_pkey')
    )
